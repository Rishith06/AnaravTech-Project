...
export const appointments: Appointment[] = [
  ...
  { id: 'j3', resourceId: 'jones', startTime: '10:45', endTime: '12:00', patientName: 'VERSCHAVE, MARY', color: '#FFB3BA' }, // Pink - 1h
  { id: 'j4', resourceId: 'jones', startTime: '11:20', endTime: '12:30', patientName: 'CARLSON, JODIE', color: '#BAE1FF' }, // Blue - 30m
  { id: 'j5', resourceId: 'jones', startTime: '13:00', endTime: '14:00', patientName: 'MARTIN, JACK H', color: '#FFDFBA' }, // Orange - 1h
  { id: 'j6', resourceId: 'jones', startTime: '13:40', endTime: '14:40', patientName: 'JOHN, DEMOR N', color: '#FFB3BA' }, // Orange - 1h
  { id: 'j7', resourceId: 'jones', startTime: '15:00', endTime: '15:50', patientName: 'VONDERHEIDE, RON', color: '#E0BBE4' }, // Purple - 45m
  { id: 'j8', resourceId: 'jones', startTime: '15:50', endTime: '17:00', patientName: 'ABBOTT, BRIAN', color: '#BAFFC9' }, // Green - 1h
  ...
  { id: 'm2', resourceId: 'miller_east', startTime: '10:00', endTime: '11:10', patientName: 'ELOMRABI, SAMUEL', color: '#BAE1FF' }, // Blue - 45m
  { id: 'm3', resourceId: 'miller_east', startTime: '11:00', endTime: '12:15', patientName: 'VASQUEZ, GINGER', color: '#FFFFBA' }, // Yellow - 1.5h
  { id: 'm4', resourceId: 'miller_east', startTime: '12:05', endTime: '13:25', patientName: 'MOLINA, LILA', color: '#BAFFC9' }, // Green - 1h
  ...
  { id: 'r1', resourceId: 'richey', startTime: '07:30', endTime: '08:40', patientName: 'MOORE, LISA', color: '#E0BBE4' }, // Purple - 45m
  { id: 'r2', resourceId: 'richey', startTime: '08:20', endTime: '09:10', patientName: 'FERNANDEZ, BRIAN', color: '#FFDFBA' }, // Orange - 45m
  { id: 'r3', resourceId: 'richey', startTime: '09:30', endTime: '10:30', patientName: 'EHRMAN, BECKY', color: '#FFB3BA' }, // Pink - 1h (gap 15m)
  { id: 'r4', resourceId: 'richey', startTime: '11:00', endTime: '12:15', patientName: 'INGRAM, BRIAN', color: '#BAE1FF' }, // Blue - 45m
  { id: 'r5', resourceId: 'richey', startTime: '12:00', endTime: '13:00', patientName: 'GARDNER, DIANE', color: '#FFFFBA' }, // Yellow - 1h
  { id: 'r6', resourceId: 'richey', startTime: '12:45', endTime: '14:00', patientName: 'GEDDES, BRIAN', color: '#BAFFC9' }, // Green - 1.5h
  ...
  { id: 't2', resourceId: 'tracey', startTime: '10:05', endTime: '11:20', patientName: 'NULL, CLARA', color: '#F3F4F6' }, // Gray/White - 1h
  { id: 't3', resourceId: 'tracey', startTime: '11:05', endTime: '12:15', patientName: 'PACA, GINA', color: '#BAFFC9' }, // Green - 45m
